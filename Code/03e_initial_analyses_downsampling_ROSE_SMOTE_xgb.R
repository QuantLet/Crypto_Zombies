...
for (train_end in c("2018-12-31",
  ...
  model_xgb <- train(formula_delisted_28days,
  ...
  model1a_xgb <- train(formula1a_delisted_28days,
  ...
  model2_xgb <- train(formula2_delisted_28days,
  ...
  rm(model_xgb,
    ...
    save(list = "summary_xgb",
       file = "summary_xgb_downsampling_all_formulas_28days.RData")
...
writexl::write_xlsx(summary_xgb,
                    "summary_xgb_downsampling_all_formulas_28days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  data_train_downsampled1a <- ROSE(delisted_in_next28days ~ .,
                                  data = data_train %>% 
                                    dplyr::select(delisted_in_next28days,
                                                  all_of(predictors_all_1a)),
                                  #  desired sample size of the resulting data set
  ...
  data_train_downsampled2 <- ROSE(delisted_in_next28days ~ .,
                                  data = data_train %>% 
                                    dplyr::select(delisted_in_next28days,
                                                  all_of(predictors_all2)),
                                  #  desired sample size of the resulting data set
  ...
  save(list = "summary_xgb",
       file = "summary_xgb_ROSE_all_formulas_28days.RData")
...
writexl::write_xlsx(summary_xgb,
                    "summary_xgb_ROSE_all_formulas_28days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  data_train_downsampled1a <- SMOTE(delisted_in_next28days ~ .,
                                    data = data_train %>% 
                                      dplyr::select(delisted_in_next28days,
                                                    all_of(predictors_all_1a)))
  ...
  data_train_downsampled2 <- SMOTE(delisted_in_next28days ~ .,
                                   data = data_train %>% 
                                     dplyr::select(delisted_in_next28days,
                                                   all_of(predictors_all2)))
  ...
  save(list = "summary_xgb",
       file = "summary_xgb_SMOTE_all_formulas_28days.RData")
...
writexl::write_xlsx(summary_xgb,
                    "summary_xgb_SMOTE_all_formulas_28days.xlsx")
