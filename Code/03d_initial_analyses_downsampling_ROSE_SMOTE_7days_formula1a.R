...
for (train_end in c("2018-12-31",
  ...
  model_glm_train_down <- train(formula_delisted_7days,
  ...
  for(i_row in 1:nrow(parameters_lasso)) {
    ...
    model_lasso_train_down <- train(formula_delisted_7days,
                               data = data_train_downsampled,
                               method = "glmnet",
                               preProcess = c("center", "scale"),
  ...
  for(i_row in 1:nrow(parameters_rf_down)) {
    ...
    model_rf_train_down <- train(formula_delisted_7days,
                                 data = data_train_downsampled,
                                 method = "ranger",
                                 num.trees = 200,
                                 preProcess = c("center", "scale"),
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_downsampling_formula1a_7days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_downsampling_formula1a_7days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  # table(data_train_downsampled$delisted_in_next7days)
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_rose_formula1a_7days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_rose_formula1a_7days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_smote_formula1a_7days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_smote_formula1a_7days.xlsx")
