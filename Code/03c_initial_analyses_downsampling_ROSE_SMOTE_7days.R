...
for (train_end in c("2018-12-31",
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_downsampling_7days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_downsampling_7days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_rose_7days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_rose_7days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_smote_7days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_smote_7days.xlsx")
