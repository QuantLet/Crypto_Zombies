...
predictors_all <- names(all_weekly_snapshots3)[c(25:100, 101, 107:109)]

predictors_all_limited <- predictors_all %>% sort() %>% 
  .[-6:-23]
...
formula_delisted_28days <- as.formula(paste0("delisted_in_next28days ~ ",
                                             paste0(predictors_all_limited, collapse = " + ")))
...
for (train_end in c("2018-12-31",
  ...
  table(data_test$delisted_in_next28days)
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_downsampling_formula1a_28days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_downsampling_formula1a_28days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_rose_formula1a_28days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_rose_formula1a_28days.xlsx")
...
for (train_end in c("2018-12-31",
  ...
  save(list = "summary_all_algos",
       file = "summary_all_algos_smote_formula1a_28days.RData")
...
writexl::write_xlsx(summary_all_algos,
                    "summary_all_algos_smote_formula1a_28days.xlsx")
